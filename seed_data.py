...
categories_data = [
    {"name": "Dust Tea", "description": "Finely ground tea leaves offering a strong, robust, and quick brew.", "order": 1, "image": "categories/dust_tea.jpg"},
    {"name": "Hotel Blend", "description": "Specially formulated tea blend perfect for hotels, restaurants, and catering.", "order": 2, "image": "categories/hotel_blend.jpg"},
    {"name": "Premium Tea Dust", "description": "High-grade fine tea dust for a rich, quick-brewing cup of tea.", "order": 3, "image": "categories/premium_tea_dust.jpg"},
    {"name": "BOP", "description": "Broken Orange Pekoe, offering a well-balanced flavor and medium strength.", "order": 4, "image": "categories/bop.jpg"},
    {"name": "Leaf Tea", "description": "Whole or large broken tea leaves for a smooth, aromatic, and flavorful cup.", "order": 5, "image": "categories/leaf_tea.jpg"},
]
...
products_data = [
    {"name": "Assam Tea", "category": "Leaf Tea",
     ...
     "price": 420, "unit": "per kg", "is_featured": True, "image": "products/assam_tea.jpg"},
    {"name": "Darjeeling Classic Tea", "category": "Leaf Tea",
     ...
     "price": 650, "unit": "per kg", "is_featured": True, "image": "products/darjeeling_classic_tea.jpg"},
    {"name": "Herbal Tea", "category": "Leaf Tea",
     "short_description": "A soothing, caffeine-free infusion of pure chamomile, herbs, and flowers.",
     "price": 380, "unit": "per kg", "is_featured": True, "image": "products/herbal_tea.jpg"},
    {"name": "Masala Tea", "category": "Hotel Blend",
     ...
     "price": 400, "unit": "per kg", "is_featured": True, "image": "products/masala_tea.jpg"},
    ...
    {"name": "Dust Tea", "category": "Dust Tea",
     ...
     "price": 320, "unit": "per kg", "is_featured": False, "image": "products/dust_tea.jpg"},
    {"name": "Hotel Blend", "category": "Hotel Blend",
     ...
     "price": 350, "unit": "per kg", "is_featured": False, "image": "products/hotel_blend.jpg"},
    {"name": "Premium Tea Dust", "category": "Premium Tea Dust",
     ...
     "price": 420, "unit": "per kg", "is_featured": False, "image": "products/premium_tea_dust.jpg"},
    {"name": "BOP", "category": "BOP",
     "short_description": "Broken Orange Pekoe, offering a well-balanced flavor and medium strength.",
     "price": 450, "unit": "per kg", "is_featured": False, "image": "products/bop.jpg"},
    {"name": "Leaf Tea", "category": "Leaf Tea",
     ...
     "price": 600, "unit": "per kg", "is_featured": False, "image": "products/leaf_tea.jpg"},
]
